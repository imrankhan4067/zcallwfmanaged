		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#wfzcallwfmanapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wfzcallwfmanapp-display": {
								"semanticObject": "wfzcallwfmanapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wf.zcallwfmanapp",
									"url": sap.ui.require.toUrl("wf/zcallwfmanapp")
								}
							}
						}
					}
